...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  // Render backdrop for mobile when sidebar is open
  // The backdrop is only rendered on mobile and when isOpen is true
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          // On desktop, sidebar is always visible, so pointer events should not be blocked
          // On mobile, allow pointer events only when open
